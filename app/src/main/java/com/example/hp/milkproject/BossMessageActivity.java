...
public class BossMessageActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        firestoreRecyclerAdapter = new FirestoreRecyclerAdapter<dataModels, BossMessageActivity.dataHolder>(firestoreRecyclerOptions) {

            @NonNull
            @Override
            public BossMessageActivity.dataHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.boss_message_worker_layout, parent, false);

                return new BossMessageActivity.dataHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull BossMessageActivity.dataHolder holder, int position, @NonNull final dataModels model) {
